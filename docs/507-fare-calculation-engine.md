# 507 — Fare Calculation Engine

## Objective
Define authoritative ride/delivery/cargo fare calculations, rounding, minimums, surcharges, and immutable calculation snapshots.
