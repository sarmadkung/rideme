# 369 — Architecture Decision Records

## Objective
Define ADR conventions and record the major architectural decisions that must remain stable unless explicitly superseded.
