# 372 — React Native Coding Standards

## Objective
Define React Native conventions for screens, navigation, hooks, native modules, offline state, performance, testing, and platform-specific code.
