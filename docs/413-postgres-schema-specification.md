# 413 — PostgreSQL Schema Specification

## Objective
Define authoritative relational schema conventions and core tables for identities, providers, vehicles, bookings, orders, jobs, payments, and operations.
