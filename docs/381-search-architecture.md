# 381 — Search Architecture

## Objective
Define search for customers, providers, merchants, products, bookings, jobs, and admin operations with indexing and consistency boundaries.
