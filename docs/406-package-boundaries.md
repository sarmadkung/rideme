# 406 — Package Boundaries

## Objective
Define which code belongs in API, worker, shared domain, database, React dashboard, customer app, driver app, and infrastructure packages.
