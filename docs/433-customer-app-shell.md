# 433 — Customer React Native App Shell

## Objective
Define customer navigation, authentication bootstrap, deep links, state hydration, error boundaries, offline handling, and shared UI.
