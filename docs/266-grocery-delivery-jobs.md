# 266 — Grocery Delivery Jobs

## Objective
Map grocery orders to operational delivery jobs, including pickup readiness, provider assignment, pickup proof, and delivery proof.
...
- Merchant workflows must separate merchant-owned data from platform-owned operational state and financial records.
