# 349 — Advanced Dispatch Optimization

## Objective
Implement optimization foundations for batching, proximity, ETA, fairness, capacity, zones, and future multi-job assignment.
