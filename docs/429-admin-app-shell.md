# 429 — Admin React App Shell

## Objective
Define dashboard routing, authentication bootstrap, layouts, navigation, permissions, error boundaries, and shared UI infrastructure.
