# 351 — Shared Ride Matching

## Objective
Implement shared-ride eligibility, seat/capacity management, compatible route matching, pricing, sequencing, and cancellation behavior.
