# 318 — API Security Testing

## Objective
Implement automated tests for authorization bypass, validation failures, rate limits, injection, object-level access, replay, and abuse scenarios.
