# 505 — Pricing Rule Priority

## Objective
Define deterministic ordering and conflict resolution among base fares, distance, duration, vehicle class, zones, fees, discounts, and promotions.
