# 480 — Financial Data Model

## Objective
Define authoritative financial entities and relationships for transactions, ledger entries, fees, commissions, refunds, settlements, taxes, and invoices.
