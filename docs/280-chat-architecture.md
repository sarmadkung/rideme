# 280 — Chat Architecture

## Objective
Define secure realtime customer-provider/support messaging with conversations, participants, messages, delivery state, moderation, and retention.
