# 446 — State Machine Catalog

## Objective
Create the authoritative catalog of lifecycle states and valid transitions for users, providers, vehicles, bookings, orders, jobs, payments, and settlements.
