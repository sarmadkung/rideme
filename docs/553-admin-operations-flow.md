# 553 — Admin Operations Flow

## Objective
Implement admin workflows for searching, inspecting, filtering, and acting on customers, providers, vehicles, bookings, orders, and jobs.
