# 392 — External Provider Fallbacks

## Objective
Define safe fallback behavior, circuit breakers, timeouts, degraded modes, and provider switching for critical dependencies.
