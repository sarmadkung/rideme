# 564 — Agent Workflow Execution Specification

## Objective
Define how the coding agent should implement each workflow, verify dependencies, run tests, update progress, and continue autonomously.
