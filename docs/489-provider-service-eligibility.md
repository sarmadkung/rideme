# 489 — Provider Service Eligibility

## Objective
Define how provider qualifications, vehicle capabilities, documents, zones, and account state determine service eligibility.
