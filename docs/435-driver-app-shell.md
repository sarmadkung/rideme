# 435 — Driver React Native App Shell

## Objective
Define driver navigation, lifecycle, authentication, availability state, realtime connection, background services, and recovery.
