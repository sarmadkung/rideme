# 485 — Service Capability Matrix

## Objective
Define the canonical capability matrix mapping vehicles, providers, services, cargo types, passenger capacity, and operational constraints.
